 ...
 * Permite almacenar información básica como el código, fecha de nacimiento,
 * sexo y peso del animal.
 */
package animales;
...
public abstract class Animal {
    ...
    /**
     * Constructor de la clase Animal.
     * Inicializa los atributos del animal verificando que los datos sean válidos.
     *
     * @param codigo código identificador del animal (5 caracteres alfanuméricos)
     * @param fechaNacimiento fecha de nacimiento del animal en formato yyyy-MM-dd
     * @param sexo sexo del animal ('M' para macho o 'H' para hembra)
     * @param peso peso del animal, debe ser mayor que 0
